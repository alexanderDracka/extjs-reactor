...
import { FormPanel, Panel, Button, ActionSheet, Container, SegmentedButton, Label, TitleBar } from '@extjs/ext-react';
        ...
        return (
            <Container padding={10}>
                ...
                <Panel shadow ui="instructions">
                    <div><b>Ext.ActionSheet</b> is a component which allows you to easily display sliding menus from any side of the screen.</div>
